  ...
  if (bug === "Meat") {
    return (
      <div className="bug-description">
        ...
        <div>
          {" "}
          You earn {formatSwarmNumber(
            parentAmount * 2 ** parentFaster,
            true,
          )}{" "}
          {bug.toLowerCase()} per second.{" "}
        </div>
      </div>
    );
  } else if (bugIndex === 0) {
    return (
      <div className="bug-description">
        ...
        <div>
          {" "}
          Each produces {production} {child}s per second.{" "}
        </div>
      </div>
    );
  } else {
